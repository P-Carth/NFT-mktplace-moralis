...
function NFTBalance() {
  ...
  async function submitBulkOrders(metaURI){
    ...
    newOrder.save({
        ...
        marketplace: rinkebyContractAddress, 
        price: priceEth, 
        target: account,
        bulk: true
    })
    ...
    <>
      ...
      <div style={{ position:"absolute", textAlign:"center", marginLeft:"auto", marginRight:"auto", top:"62px", zIndex:"2"}}>
        ...
        <div style={{width:"100px", marginLeft:"auto", marginRight:"auto"}}>
          <img src={inputValue.image} className="zoomIn" style={{ textAlign:"center", alignContent:"center", width:"150px", height:"100px", borderRadius:"50%"}} />
        </div> 
      </div>
